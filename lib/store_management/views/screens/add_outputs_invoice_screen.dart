...
class AddOutputsInvoiceScreen extends StatelessWidget {
  AddOutputsInvoiceScreen({super.key});
                                ...
                                children: [
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width *
                                        0.15,
                                    child: Text(
                                      '${controller.inputsProduct[index].name}',
                                      overflow: TextOverflow.fade,
                                      softWrap: true,
                                      maxLines: 1,
                                      textAlign: TextAlign.center,
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width *
                                        0.15,
                                    child: Text(
                                      '${controller.inputsProduct[index].purchasingPrice}',
                                      overflow: TextOverflow.fade,
                                      softWrap: true,
                                      maxLines: null,
                                      textAlign: TextAlign.center,
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width *
                                        0.15,
                                    child: Text(
                                      '${controller.inputsProduct[index].addedValue}',
                                      overflow: TextOverflow.fade,
                                      softWrap: true,
                                      maxLines: null,
                                      textAlign: TextAlign.center,
                                  ...
                                  SizedBox(
                                    width: MediaQuery.of(context).size.width *
                                        0.15,
                                    child: Text(
                                      '${controller.inputsProduct[index].purchasingPrice * controller.inputsProduct[index].addedValue * controller.inputsProduct[index].numPerItem}',
                                      overflow: TextOverflow.fade,
                                      softWrap: true,
                                      maxLines: null,
                                      textAlign: TextAlign.center,
